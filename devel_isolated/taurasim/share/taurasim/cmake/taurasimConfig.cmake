...
if("FALSE" STREQUAL "TRUE")
  ...
  set(taurasim_DEVEL_PREFIX /home/thxssio/projects/VSSS/build_isolated/taurasim/devel/devel)
  set(taurasim_INSTALL_PREFIX "")
  set(taurasim_PREFIX ${taurasim_DEVEL_PREFIX})
else()
  set(taurasim_SOURCE_PREFIX "")
  set(taurasim_DEVEL_PREFIX "")
  set(taurasim_INSTALL_PREFIX /home/thxssio/projects/VSSS/devel_isolated/taurasim)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'taurasim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/thxssio/projects/VSSS/devel_isolated/taurasim/lib;/home/thxssio/projects/matrice_ws/devel/lib;/opt/ros/noetic/lib)
