...
def generate_launch_description():
    ...
    declare_team_color = DeclareLaunchArgument('team_color', default_value='yellow')
    declare_robots = DeclareLaunchArgument('ROBOTS', default_value='3', description='Number of robots')

    # Incluir o arquivo de lançamento do Gazebo
