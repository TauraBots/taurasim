...
def generate_launch_description():
    ...
    declare_robots_per_team = DeclareLaunchArgument('robots_per_team', default_value='1')
    ...
    declare_yellow_namespace = DeclareLaunchArgument('yellow_namespace', default_value='yellow_team')
    declare_blue_namespace = DeclareLaunchArgument('blue_namespace', default_value='blue_team')
    declare_yellow_robots = DeclareLaunchArgument('yellow_robots', default_value='1')
    declare_blue_robots = DeclareLaunchArgument('blue_robots', default_value='1')
    ...
    yellow_keyboard_group = GroupAction(
        ...
        actions=[
            Node(
                ...
                namespace=LaunchConfiguration('yellow_namespace'),
                output='screen',
                parameters=[
    ...
    # Grupo de nós para o controle por teclado do time azul
    blue_keyboard_group = GroupAction(
        ...
        actions=[
            Node(
                ...
                namespace=LaunchConfiguration('blue_namespace'),
                output='screen',
                parameters=[
    ...
    # Incluir o script spawn_robots_v2.py para lançar os robôs do time amarelo
